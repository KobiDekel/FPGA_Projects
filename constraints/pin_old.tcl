...
set_location_assignment PIN_AF25 -to ir_key[0]
set_location_assignment PIN_AE24 -to ir_key[1]
set_location_assignment PIN_AF24 -to ir_key[2]
set_location_assignment PIN_AB22 -to ir_key[3]
